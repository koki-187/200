...
export const APP_VERSION = '3.151.0';
export const BUILD_DATE = '2025-12-06';
export const BUILD_DESCRIPTION = 'Final Release Candidate - Favicon fix, version unification, comprehensive testing completed';
