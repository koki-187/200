...
INSERT OR IGNORE INTO error_logs (id, level, category, message, recovery_attempted, recovery_success)
VALUES ('test-001', 'info', 'system_startup', 'Error logging system initialized', 0, 0);
