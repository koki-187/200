...
### 本番環境URL
- **Production URL (Latest v3.25.0)**: https://5f326086.real-estate-200units-v2.pages.dev 🆕
...
- **Showcase**: https://5f326086.real-estate-200units-v2.pages.dev/showcase
- **Deal Creation (OCR UI強化版)**: https://5f326086.real-estate-200units-v2.pages.dev/deals/new
- **Deal Detail (with Map)**: https://5f326086.real-estate-200units-v2.pages.dev/deals/:id
- **API Documentation**: https://5f326086.real-estate-200units-v2.pages.dev/api/docs 🆕
- **API Specification (OpenAPI)**: https://5f326086.real-estate-200units-v2.pages.dev/api/openapi.json 🆕
...
#### 🆕 v3.29.0で修正されたバグ
1. ✅ テンプレート選択ボタンが動作しない → 修正完了
2. ✅ OCRファイル選択ボタンが動作しない → 修正完了
3. ✅ OCRドラッグ&ドロップが動作しない → 修正完了
4. ✅ 購入条件チェックで「案件ID不明」エラー → 修正完了
...
- **バージョン**: v3.29.0 (Production - 全ユーザー報告バグ修正完了) 🆕
- **進捗状況**: Phase 1完了（100%）+ Phase 2完了、全機能実装・テスト・バグ修正完了 ✅
- **最新改善**: テンプレート選択・OCR・購入条件チェックの重大バグ5件修正完了 🆕
- **デプロイ日**: 2025-11-20
- **本番URL**: https://ede8424f.real-estate-200units-v2.pages.dev 🆕
